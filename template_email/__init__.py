...
class TemplateEmail(EmailMultiAlternatives):
    ...
    def render(self):
        ...
        context_subject = context.copy(); context_subject.update({'_subject':True})
        context_body    = context.copy(); context_body.update({'_body':True})
        context_html    = context.copy(); context_html.update({'_bodyhtml':True})
